...
**********************************************************************************************************************/
#define gtbHeaderVerion(...)                (2)
/**********************************************************************************************************************
    function switches
**********************************************************************************************************************/
#define GTB_CONFIG_VARIABLE_SHOW            (1)
#define GTB_CONFIG_BIT_MANIPULATION         (0)
#define GTB_CONFIG_LOOP_CONTROL             (0)
#define GTB_CONFIG_MEMORY_ALLOCATION        (1)
#define GTB_CONFIG_MEMORY_SHOW              (0)
#define GTB_CONFIG_TIMING                   (0)
/**********************************************************************************************************************
    macros for bit manipulation and basic math operations
**********************************************************************************************************************/
#if GTB_CONFIG_BIT_MANIPULATION > 0
#define bit(x)                              (1UL << (x))
...
#endif  // GTB_CONFIG_BIT_MANIPULATION > 0
/**********************************************************************************************************************
    macros for looping
**********************************************************************************************************************/
#if GTB_CONFIG_LOOP_CONTROL > 0
...
#define forever                             for (;;)
#endif  //  GTB_CONFIG_LOOP_CONTROL > 0
/**********************************************************************************************************************
    macros for showing variable value
**********************************************************************************************************************/
#if GTB_CONFIG_VARIABLE_SHOW > 0
#define __SHOW_METHOD(fmt, ...)             printf(fmt, ## __VA_ARGS__)
/*
 *  show variable's name and its size
 */
#define size(var)                           __SHOW_METHOD("Size of "#var"\t\t= %d\n\r", sizeof(var))
/*
...
#endif  // GTB_CONFIG_VARIABLE_SHOW > 0
/**********************************************************************************************************************
    macros for memory allocating
**********************************************************************************************************************/
#if GTB_CONFIG_BIT_MANIPULATION > 0
#define __MALLOC_METHOD(size)               malloc(size)

#define new(type)                           (type *)__MALLOC_METHOD(sizeof(type))
#endif  // GTB_CONFIG_BIT_MANIPULATION
/**********************************************************************************************************************
    timing
**********************************************************************************************************************/
#if (GTB_CONFIG_LOOP_CONTROL > 0 && GTB_CONFIG_TIMING > 0)
/**********************************************************************************************************************
...
#endif  // GTB_CONFIG_LOOP_CONTROL > 0 && GTB_CONFIG_TIMING > 0
/**********************************************************************************************************************
    memory show
**********************************************************************************************************************/
